...
def OurModel(input_shape, action_space, learning_rate):
    ...
    Actor.compile(loss='categorical_crossentropy', optimizer=RMSprop(learning_rate=learning_rate))
...
class PGAgent:
    ...
    def __init__(self, env_name):
        ...
        self.EPISODES, self.max_average = 300, -21.0 # specific for pong
        ...
        self.path = '{}_PG_{}'.format(self.env_name, self.learning_rate)
        self.Model_name = os.path.join(self.Save_Path, self.path)

        # Create Actor network model
        self.Actor = OurModel(input_shape=self.state_size, action_space = self.action_size, learning_rate=self.learning_rate)
